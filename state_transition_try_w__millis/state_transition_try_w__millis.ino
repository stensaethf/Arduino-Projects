...
int notes [44] = {c, 0, d, 0, e, 0, f, 0, g, 0, g, 0, a, 0, a, 0, a, 0, a, 0, g, 0, f, 0, f, 0, f, 0, f, 0, e, 0, e, 0, d, 0, d, 0, d, 0, d, 0, c, 0};
int delay_times [44] = {900, 100, 900, 100, 900, 100, 900, 100, 1900, 100, 1900, 100, 900, 100, 900, 100, 900, 100, 900, 100, 3900, 100, 900, 100, 900, 100, 900, 100, 900, 100, 1900, 100, 1900, 100, 900, 100, 900, 100, 900, 100, 900, 100, 3900, 100};
int servo_speed [44] = {1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90, 1, 1, 90, 90};
...
void song()
{
  ...
  for (int j = 0; j < 44; j++)
  {
    ...
    if (currentMillis - previousMillis >= delay_times[j])
    {
      tone(beeper, notes[j]);
      delay(delay_times[j]);
